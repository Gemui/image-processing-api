...
describe('Test image endpoint  responses', function () {
    it('Test Response with no image attribute in query params should be : File name is required', function () { return __awaiter(void 0, void 0, void 0, function () {
        var response;
    ...
    it('Test Response with invalid image name should be : invalid image name', function () { return __awaiter(void 0, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
